...
* **Machine Learning Algorithms:** Implementing classic models (KNN, SVM, Random Forest, etc.) and understanding their mechanics.
* **Model Evaluation:** Using metrics like accuracy, confusion matrices, and F1-scores to assess performance.
...
## 🛠️ Tech Stack & Tools
* **Languages:** Python
* **Libraries:** `scikit-learn`, `pandas`, `numpy`, `opencv-python`, `matplotlib`, `kagglehub`
